...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0089, code lost:
        sBackgroundThread.postAndReply(r2, new androidx.core.provider.FontsContractCompat.C01373());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r8, final androidx.core.provider.FontRequest r9, final androidx.core.content.res.ResourcesCompat.FontCallback r10, final android.os.Handler r11, boolean r12, int r13, final int r14) {
        ...
        L_0x0063:
            ...
            monitor-enter(r5)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r6 = sPendingReplies     // Catch:{ all -> 0x0094 }
            java.lang.Object r6 = r6.get(r0)     // Catch:{ all -> 0x0094 }
            java.util.ArrayList r6 = (java.util.ArrayList) r6     // Catch:{ all -> 0x0094 }
            if (r6 == 0) goto L_0x0078
            if (r4 == 0) goto L_0x0076
            r6.add(r4)     // Catch:{ all -> 0x0094 }
        L_0x0076:
            monitor-exit(r5)     // Catch:{ all -> 0x0094 }
            return r3
        L_0x0078:
            if (r4 == 0) goto L_0x0088
            java.util.ArrayList r7 = new java.util.ArrayList     // Catch:{ all -> 0x0094 }
            r7.<init>()     // Catch:{ all -> 0x0094 }
            r6 = r7
            r6.add(r4)     // Catch:{ all -> 0x0094 }
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r7 = sPendingReplies     // Catch:{ all -> 0x0094 }
            r7.put(r0, r6)     // Catch:{ all -> 0x0094 }
        L_0x0088:
            monitor-exit(r5)     // Catch:{ all -> 0x0094 }

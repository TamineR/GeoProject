    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0243R.C0245id.topPanel) {
                    topPanel = child;
                } else if (id == C0243R.C0245id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0243R.C0245id.contentPanel && id != C0243R.C0245id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }

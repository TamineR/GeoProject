...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0243R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0243R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0243R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0243R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0243R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0243R.styleable.MenuView_subMenuArrow);
        TypedArray b = context.getTheme().obtainStyledAttributes((AttributeSet) null, new int[]{16843049}, C0243R.attr.dropDownListViewStyle, 0);
    ...
    public void onFinishInflate() {
        ...
        TextView textView = (TextView) findViewById(C0243R.C0245id.title);
        this.mTitleView = textView;
        int i = this.mTextAppearance;
        if (i != -1) {
            textView.setTextAppearance(this.mTextAppearanceContext, i);
        }
        this.mShortcutView = (TextView) findViewById(C0243R.C0245id.shortcut);
        ImageView imageView = (ImageView) findViewById(C0243R.C0245id.submenuarrow);
        this.mSubMenuArrowView = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0243R.C0245id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0243R.C0245id.content);
    }
    ...
    private void insertIconView() {
        ImageView imageView = (ImageView) getInflater().inflate(C0243R.layout.abc_list_menu_item_icon, this, false);
        this.mIconView = imageView;
        addContentView(imageView, 0);
    }

    private void insertRadioButton() {
        RadioButton radioButton = (RadioButton) getInflater().inflate(C0243R.layout.abc_list_menu_item_radio, this, false);
        this.mRadioButton = radioButton;
        addContentView(radioButton);
    }

    private void insertCheckBox() {
        CheckBox checkBox = (CheckBox) getInflater().inflate(C0243R.layout.abc_list_menu_item_checkbox, this, false);

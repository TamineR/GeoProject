...
public abstract class FragmentTransaction {
    ...
    int mExitAnim;
    String mName;
    ArrayList<C0196Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0196Op {
        ...
        C0196Op(int cmd, Fragment fragment) {
            this.mCmd = cmd;
        ...
        C0196Op(int cmd, Fragment fragment, Lifecycle.State state) {
            this.mCmd = cmd;
            this.mFragment = fragment;
    ...
    public void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0196Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0196Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0196Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0196Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0196Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0196Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0196Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0196Op(10, fragment, state));
        return this;
    }

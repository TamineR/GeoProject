...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f27x;
    }

    /* access modifiers changed from: package-private */
    public float getStartY() {
        return this.mStartMotionPath.f28y;
    }

    /* access modifiers changed from: package-private */
    public float getFinalX() {
        return this.mEndMotionPath.f27x;
    }

    /* access modifiers changed from: package-private */
    public float getFinalY() {
        return this.mEndMotionPath.f28y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f27x;
        start.top = this.mStartMotionPath.f28y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f27x;
        end.top = this.mEndMotionPath.f28y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f27x - this.mStartMotionPath.f27x;
        float dy = this.mEndMotionPath.f28y - this.mStartMotionPath.f28y;
        float startCenterX = this.mStartMotionPath.f27x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f28y + (this.mStartMotionPath.height / 2.0f);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f27x + " y: " + this.mStartMotionPath.f28y + " end: x: " + this.mEndMotionPath.f27x + " y: " + this.mEndMotionPath.f28y;
    }
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float float_l = this.mStartMotionPath.f27x + ((this.mEndMotionPath.f27x - this.mStartMotionPath.f27x) * position);
            float float_t = this.mStartMotionPath.f28y + ((this.mEndMotionPath.f28y - this.mStartMotionPath.f28y) * position);
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f27x - this.mStartMotionPath.f27x;
        float dTop = this.mEndMotionPath.f28y - this.mStartMotionPath.f28y;

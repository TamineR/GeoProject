...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0251R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
    ...
    private int findId(java.lang.String r6) {
        ...
        L_0x0031:
            ...
            java.lang.Class<androidx.constraintlayout.widget.R$id> r2 = androidx.constraintlayout.widget.C0251R.C0253id.class

...
public class StateSet {
    ...
    private void load(android.content.Context r14, org.xmlpull.v1.XmlPullParser r15) {
        /*
            ...
            int[] r1 = androidx.constraintlayout.widget.C0251R.styleable.StateSet
        ...
        L_0x000f:
            ...
            int r5 = androidx.constraintlayout.widget.C0251R.styleable.StateSet_defaultState
        ...
        L_0x0024:
            ...
            r4 = 0
            r5 = 0
            int r6 = r15.getEventType()     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
        L_0x002b:
            r7 = 1
            ...
            goto L_0x00bc
        L_0x003a:
            java.lang.String r7 = r15.getName()     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            boolean r7 = r8.equals(r7)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
        ...
        L_0x0045:
            ...
            goto L_0x00bc
        L_0x0048:
            java.lang.String r11 = r15.getName()     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            r3 = r11
            r11 = -1
            int r12 = r3.hashCode()     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            switch(r12) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
        L_0x0055:
            goto L_0x007b
        L_0x0056:
            java.lang.String r8 = "Variant"
            boolean r8 = r3.equals(r8)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
        ...
        L_0x007b:
            ...
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            r8.<init>()     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            java.lang.String r9 = "unknown tag "
            r8.append(r9)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            r8.append(r3)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            java.lang.String r8 = r8.toString()     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            android.util.Log.v(r7, r8)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            goto L_0x00b5
        L_0x009a:
            androidx.constraintlayout.widget.StateSet$Variant r7 = new androidx.constraintlayout.widget.StateSet$Variant     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            r7.<init>(r14, r15)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            if (r5 == 0) goto L_0x00b5
            r5.add(r7)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            goto L_0x00b5
        L_0x00a5:
            androidx.constraintlayout.widget.StateSet$State r7 = new androidx.constraintlayout.widget.StateSet$State     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            r7.<init>(r14, r15)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            r5 = r7
            android.util.SparseArray<androidx.constraintlayout.widget.StateSet$State> r7 = r13.mStateList     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            int r8 = r5.mId     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            r7.put(r8, r5)     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            goto L_0x00b5
        L_0x00b3:
            goto L_0x00b5
        L_0x00b4:
        ...
        L_0x00b6:
            ...
            r4 = r7
        L_0x00bc:
            int r7 = r15.next()     // Catch:{ XmlPullParserException -> 0x00c9, IOException -> 0x00c4 }
            r6 = r7
            goto L_0x002b
        L_0x00c3:
            goto L_0x00cd
    ...
    static class State {
        ...
        public State(Context context, XmlPullParser parser) {
            TypedArray a = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0251R.styleable.State);
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0251R.styleable.State_android_id) {
                    this.mId = a.getResourceId(attr, this.mId);
                } else if (attr == C0251R.styleable.State_constraints) {
    ...
    static class Variant {
        ...
        public Variant(Context context, XmlPullParser parser) {
            TypedArray a = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0251R.styleable.Variant);
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0251R.styleable.Variant_constraints) {
                    this.mConstraintID = a.getResourceId(attr, this.mConstraintID);
                    String type = context.getResources().getResourceTypeName(this.mConstraintID);
                    String resourceName = context.getResources().getResourceName(this.mConstraintID);
                    if ("layout".equals(type)) {
                ...
                } else if (attr == C0251R.styleable.Variant_region_heightLessThan) {
                    this.mMaxHeight = a.getDimension(attr, this.mMaxHeight);
                } else if (attr == C0251R.styleable.Variant_region_heightMoreThan) {
                    this.mMinHeight = a.getDimension(attr, this.mMinHeight);
                } else if (attr == C0251R.styleable.Variant_region_widthLessThan) {
                    this.mMaxWidth = a.getDimension(attr, this.mMaxWidth);
                } else if (attr == C0251R.styleable.Variant_region_widthMoreThan) {

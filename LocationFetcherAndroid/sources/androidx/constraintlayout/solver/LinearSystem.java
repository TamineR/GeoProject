...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object anchor) {
        ...
        if (anchor instanceof ConstraintAnchor) {
            ...
            if (variable.f29id == -1 || variable.f29id > this.mVariablesID || this.mCache.mIndexedVariables[variable.f29id] == null) {
                if (variable.f29id != -1) {
                    variable.reset();
                }
    ...
    private final int optimize(Row goal, boolean b) {
        ...
        while (!done) {
            ...
            if (goal.getKey() != null) {
                this.mAlreadyTestedCandidates[goal.getKey().f29id] = USE_SYNONYMS;
            }
            SolverVariable pivotCandidate = goal.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f29id]) {
                    return tries;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f29id] = USE_SYNONYMS;
            }
            if (pivotCandidate != null) {

...
public class BarrierReference extends HelperReference {
    ...
    public void apply() {
        getHelperWidget();
        int direction = 0;
        switch (C01061.f31xf452c4aa[this.mDirection.ordinal()]) {
            case 1:
            case 2:
                direction = 0;
                break;
    ...
    static /* synthetic */ class C01061 {
        ...
        static final /* synthetic */ int[] f31xf452c4aa;
        ...
        static {
            ...
            try {
                f31xf452c4aa[State.Direction.START.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f31xf452c4aa[State.Direction.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f31xf452c4aa[State.Direction.END.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f31xf452c4aa[State.Direction.TOP.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f31xf452c4aa[State.Direction.BOTTOM.ordinal()] = 6;

...
public abstract class WidgetRun implements Dependency {
    ...
    public final DependencyNode getTarget(ConstraintAnchor anchor) {
        ...
        int i = C01141.f42x4c44d048[anchor.mTarget.mType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01141 {
        ...
        static {
            ...
            try {
                f42x4c44d048[ConstraintAnchor.Type.BASELINE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f42x4c44d048[ConstraintAnchor.Type.BOTTOM.ordinal()] = 5;

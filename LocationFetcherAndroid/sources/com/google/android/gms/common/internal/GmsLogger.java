...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void mo7611d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void mo7612d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: v */
    public final void mo7620v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void mo7621v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: i */
    public final void mo7616i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void mo7617i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: w */
    public final void mo7622w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void mo7623w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    /* renamed from: e */
    public final void mo7613e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void mo7614e(String str, String str2, Throwable th) {
        if (canLog(6)) {

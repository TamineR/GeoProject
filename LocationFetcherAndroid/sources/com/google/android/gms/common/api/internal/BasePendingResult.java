...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    public void cancel() {
        /*
            ...
            goto L_0x002a
        L_0x000c:
            com.google.android.gms.common.internal.ICancelToken r1 = r2.zady     // Catch:{ all -> 0x002c }
            if (r1 == 0) goto L_0x0017
            com.google.android.gms.common.internal.ICancelToken r1 = r2.zady     // Catch:{ RemoteException -> 0x0016 }
            r1.cancel()     // Catch:{ RemoteException -> 0x0016 }
            goto L_0x0017
        L_0x0016:
            r1 = move-exception
        L_0x0017:
            R r1 = r2.zacj     // Catch:{ all -> 0x002c }
            zab((com.google.android.gms.common.api.Result) r1)     // Catch:{ all -> 0x002c }
            r1 = 1
            r2.zadw = r1     // Catch:{ all -> 0x002c }

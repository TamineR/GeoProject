...
public final class zax implements zabs {
    ...
    public zax(Context context, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map<Api.AnyClientKey<?>, Api.Client> map, ClientSettings clientSettings, Map<Api<?>, Boolean> map2, Api.AbstractClientBuilder<? extends zad, SignInOptions> abstractClientBuilder, ArrayList<zaq> arrayList, zaaw zaaw, boolean z) {
        ...
        for (Map.Entry next2 : map.entrySet()) {
            ...
            if (!client.requiresGooglePlayServices()) {
                ...
                z2 = z7;
                z3 = false;
            } else if (!this.zaew.get(api).booleanValue()) {
                z3 = z5;
                z4 = true;
                z2 = true;
            } else {
    ...
    private final boolean zaac() {
        /*
            ...
            r0.lock()
            boolean r0 = r3.zafd     // Catch:{ all -> 0x0046 }
            r1 = 0
            if (r0 == 0) goto L_0x0040
            boolean r0 = r3.zafa     // Catch:{ all -> 0x0046 }
            if (r0 != 0) goto L_0x000f
            goto L_0x0040
        L_0x000f:
            java.util.Map<com.google.android.gms.common.api.Api$AnyClientKey<?>, com.google.android.gms.common.api.internal.zaw<?>> r0 = r3.zaev     // Catch:{ all -> 0x0046 }
        ...
        L_0x0019:
            ...
            com.google.android.gms.common.api.Api$AnyClientKey r2 = (com.google.android.gms.common.api.Api.AnyClientKey) r2     // Catch:{ all -> 0x0046 }
            com.google.android.gms.common.ConnectionResult r2 = r3.zaa((com.google.android.gms.common.api.Api.AnyClientKey<?>) r2)     // Catch:{ all -> 0x0046 }
